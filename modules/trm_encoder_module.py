...
class TrmEncoderModule(GPT2PreTrainedModel):
    def __init__(self, config, n_utterance_positions):
        ...
        self.h = nn.ModuleList([TrmEncoderBlock(config, scale=True) for _ in range(config.n_layer)])
